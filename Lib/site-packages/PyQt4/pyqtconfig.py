...
_pkg_config = {
    ...
    'pyqt_sip_flags':    '-x VendorID -t WS_WIN -x PyQt_OpenSSL -x PyQt_NoPrintRangeBug -t Qt_4_8_0 -x Py_v3 -g',
    'pyqt_version':      0x040904,
    'pyqt_version_str':  '4.9.4',
    'qt_data_dir':       'D:\\Qt\\4.8.4',
    'qt_dir':            'D:\\Qt\\4.8.4',
    'qt_edition':        'free',
    'qt_framework':      0,
    'qt_inc_dir':        'D:\\Qt\\4.8.4\\include',
    'qt_lib_dir':        'D:\\Qt\\4.8.4\\lib',
    'qt_threaded':       1,
    'qt_version':        0x040804,
    'qt_winconfig':      'shared'
}
