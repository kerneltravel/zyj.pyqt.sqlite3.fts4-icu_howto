// qtextformat.sip generated by MetaSIP on Tue Jun 26 14:12:48 2012
//
...
%End
%If (Qt_5_0_0 -)
    void setFontAbsoluteLetterSpacing(qreal absoluteSpacing);
%End
%If (Qt_5_0_0 -)
    qreal fontAbsoluteLetterSpacing() const;
%End
%If (Qt_5_0_0 -)
    void setFontStretch(qreal factor);
%End
%If (Qt_5_0_0 -)
