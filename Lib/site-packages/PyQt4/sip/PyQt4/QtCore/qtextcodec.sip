// qtextcodec.sip generated by MetaSIP on Tue Jun 26 14:12:46 2012
//
...
%If (Qt_5_0_0 -)
    QTextDecoder *makeDecoder(QFlags<QTextCodec::ConversionFlag> flags = DefaultConversion) const /Factory/;
%End
%If (- Qt_5_0_0)
...
%End
%If (Qt_5_0_0 -)
    QTextEncoder *makeEncoder(QFlags<QTextCodec::ConversionFlag> flags = DefaultConversion) const /Factory/;
%End
%If (- Qt_5_0_0)
