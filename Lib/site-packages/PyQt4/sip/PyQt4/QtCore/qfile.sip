// qfile.sip generated by MetaSIP on Tue Jun 26 14:12:46 2012
//
...
%If (Qt_5_0_0 -)
    bool open(int fd, QFlags<QIODevice::OpenModeFlag> flags, QFlags<QFile::FileHandleFlag> handleFlags = QFile::DontCloseHandle) /ReleaseGIL/;
%End
%If (- Qt_5_0_0)
